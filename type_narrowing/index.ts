...
function makeSound(animal: DogAnimal | CatAnimal) {
...
// exemplo 3: Usando in para verificar propriedades de objetos
type Fish = { swim: () => void };
type Bird = { fly: () => void };
...
const myFish: Fish = { swim: () => {} };
const myBird: Bird = { fly: () => {} };
...
const strLength: string = (someValue as string).toLocaleLowerCase();
